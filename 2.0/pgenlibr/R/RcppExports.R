...
NewDense <- function(pgen, variant_subset, meanimp = NULL, covariates = NULL) {
    .Call(`_pgenlibr_NewDense`, pgen, variant_subset, meanimp, covariates)
}
...
NewLassoObj <- function(ni, pfac = NULL, beta = NULL) {
    .Call(`_pgenlibr_NewLassoObj`, ni, pfac, beta)
}

GradientDescentObj <- function(ni, beta = NULL) {
    .Call(`_pgenlibr_GradientDescentObj`, ni, beta)
}
