...
NewPlinkMatrix <- function(filename, variant_subset, sample_subset = NULL, pvar = NULL, raw_sample_ct = NULL) {
    .Call(`_pgenlibr_NewPlinkMatrix`, filename, variant_subset, sample_subset, pvar, raw_sample_ct)
}
